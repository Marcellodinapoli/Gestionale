/**
 * Applica migrazioni 020–024 (conferimento + pratiche giudiziali).
 */
...
const files = [
  "020_conferimento_legale.sql",
  "021_pratica_giudiziale.sql",
  "022_giudiziale_archiviazione.sql",
  "023_valutazione_legale.sql",
  "024_strategia_giudiziale.sql",
];

console.log(`Applico 020–024 su ${config.database || "connection-string"}…`);
...
try {
  ...
  const check = await pool.request().query(`
    SELECT OBJECT_ID('dbo.PraticheGiudiziali', 'U') AS PraticheGiudiziali
  `);
