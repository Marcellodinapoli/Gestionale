...
export async function listMessaggiInterni(
...
export async function createMessaggiInterni(
  cfg: ConnectorConfig["db"],
  tenantId: string,
  ...
  for (const item of items) {
    ...
    if (item.praticaId) req.input("praticaId", sql.UniqueIdentifier, item.praticaId);
    await req.query(`
...
export async function getMessaggioInternoById(
  cfg: ConnectorConfig["db"],
  tenantId: string,
  id: string
) {
...
export async function updateMessaggioInternoLetto(
  cfg: ConnectorConfig["db"],
  tenantId: string,
  id: string,
  letto: boolean
...
export async function deleteMessaggioInterno(
  cfg: ConnectorConfig["db"],
  tenantId: string,
  id: string
) {
...
export async function updateMessaggioInternoTesto(
  cfg: ConnectorConfig["db"],
  tenantId: string,
  id: string,
  testo: string
...
export async function deleteMessaggiInterniByPratica(
  cfg: ConnectorConfig["db"],
  tenantId: string,
  praticaId: string
) {
