...
import { createProvvigioniRouter } from "./routes/provvigioni.js";
import { createRegistrazioniRouter } from "./routes/registrazioni.js";
import {
  createDocumentiRouter,
  createFattureRouter,
  createPianoRateRouter,
} from "./routes/praticaContabile.js";
import { createGarantiRouter } from "./routes/garanti.js";
...
app.use("/api/v1/tenants/:tenantId/sedi", createSediRouter(cfg));
app.use("/api/v1/tenants/:tenantId/users", createUsersRouter(cfg));
app.use("/api/v1/tenants/:tenantId/configurazione", createConfigurazioneRouter(cfg));
app.use("/api/v1/tenants/:tenantId/postazioni", createPostazioniRouter(cfg));
